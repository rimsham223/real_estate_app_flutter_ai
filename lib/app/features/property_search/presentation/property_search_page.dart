...
class _SearchHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Hello, ${_userDisplayName()}', style: theme.textTheme.titleMedium?.copyWith(color: Colors.white.withValues(alpha: 0.9), fontWeight: FontWeight.w600)),
          ...
          SearchBarWidget(
            ...
            onSubmitted: () => context.read<PropertySearchBloc>().add(SearchPropertiesEvent(state.currentFilters)),
  ...
  String _userDisplayName() {
    ...
    if (fullName != null && fullName.trim().isNotEmpty) return fullName.trim().split(' ').first;
